...
const PIECES = [
  ...
  {
    out: 'hotbar.png', from: 'Action_panel.png', x: 12, y: 44, w: 168, h: 20,
    slice: null,
    note: 'Планка быстрого доступа: 10 гнёзд 12x12, первое в (6,6), шаг 16. Не тянется — гнёзда нарисованы внутри, и растяжение размазало бы их.',
  },
  {
    out: 'ring.png', from: 'character_panel.png', x: 2, y: 34, w: 30, h: 30,
    slice: null,
    note: 'Круглая деревянная рама (пустая, без портрета) — под мини-карту. Стенка 4px, отверстие 22px по центру. Справа к кольцу примыкает основание полосы HP: в наборе они срослись, отдельного кольца нет.',
  },
];
